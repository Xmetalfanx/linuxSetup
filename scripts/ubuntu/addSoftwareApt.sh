...
echo -e "Please Select Task\n"
	...
	echo -e "3. \t [MAYBE MOVED TO UNIVERSAL SOFTWARE SECTION]Install Web Browser [Submenu] (Chrome, Chromium, Firefox, or Vivaldi)"
	echo -e "4. \t Install Various Useful Apps "
	echo -e "5. \t [MAYBE MOVED TO UNIVERSAL SOFTWARE SECTION] Install Etcher to put ISOs on USB drives"
  	echo -e "6. \t [MAYBE MOVED TO UNIVERSAL SOFTWARE SECTION]Install Atom Editor"
	echo -e "7. \t [MAYBE MOVED TO UNIVERSAL SOFTWARE SECTION]Install\Update MPV from PPA"
	echo -e "8. \t [MAYBE MOVED TO UNIVERSAL SOFTWARE SECTION]Install Wine and PlayOnLinux"
	echo -e "9. \t [MAYBE MOVED TO UNIVERSAL SOFTWARE SECTION]Install Sublime Text"
