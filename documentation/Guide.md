...
3. [Sub-Menu] Office/Productivity/Programming Related Apps
    ...
    1. [Atom (Text/Code) Editor](https://github.com/atom/atom)
        ...
        - OpenSuse/(?) Fedora note:
          ...
          - SOLUTION: if it asks/prompts you about this, click "I" for Ignore and
          - It will still install and work fine.
          - This is NOT the way I wanted it, but this issue is entirely out of my hands and out of say OpenSuse's hands too.
...
4. [Sub-Menu] Multimedia Apps
    ...
    K. Show info (without installing or compiling anything) about MakeMKV Key and when it expires
        - the app is free but you have to change the key from month to month
...
6. [Sub-Menu] Distro Specific tasks
    ...
    1. (Example) setup synaptic, gdebi and stuff like that
        - This is for commonly done tasks post-install, for specific distros
